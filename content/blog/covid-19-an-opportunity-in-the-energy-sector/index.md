...
date: "2020-10-07T12:19:40+00:00"
image: "hero.jpg"
preview_image: "preview.jpg"
excerpt: "It is no secret that the energy industry is going through a difficult time. Investments are getting smaller, or sometimes even stopped. People are laid off and the number of orders is in free fall for some companies."
description: "It is no secret that the energy industry is going through a difficult time. Investments are getting smaller, or sometimes even stopped. People are laid off and the number of orders is in free fall for some companies."
subtitle: "Time for digital transformation is now"
...
read_more:
  ...
  items:
    ...
    -
      ...
      url: "/blog/what-do-we-mean-with-truly-digital/"
      label: "Read article"
    -
      title: "Product Demo"
      url: "/demo/#book-demo"
...
Because then, new technologies can ensure that key factors are not slowed down, that [transparency](/digital-trail/) is improved and that the recovery of the industry is accelerated. Because what if we can finally create [paperless offices](/blog/what-do-we-mean-with-truly-digital/), eliminating human error? What if we can make data-driven decisions, see real time availability of materials and compare the specifications of a certain product with the product requirements of the end user?
